...
const Venditore = () => 
{
    ...
    useCheckLogin('http://167.235.9.22/listinophp/login/logToken.php', () => 
    {
        Promise.all(
            [
                postFetchNoBody('http://167.235.9.22/listinophp/login/getDoingOrdersSELL.php', ab.signal),
                postFetchNoBody('http://167.235.9.22/listinophp/login/getDoneOrdersSELL.php', ab.signal), 
            ])
            .then((data) => 
            {
                const [doingOrders, doneOrders] = data
            ...
            <div>
                ...
                >
                    ...
                    <div className={styles.header_button_container}>
                        <button className={styles.modbutton} onClick={() => window.location = '/venditore/dashboard'}>
                            Modifica i Prodotti
                        </button>
